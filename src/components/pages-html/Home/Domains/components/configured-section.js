      ...
      <>
        ...
        <div className='px-2 sm:px-10'>
          ...
          <div className='my-3 text-left'>
            ...
            <div className='flex items-start justify-start p-2 space-x-10 bg-gray-50 rounded-md'>
              <div>
        ...
        <>
          ...
          <div className='px-2 sm:px-10'>
            ...
            <div className='my-3 text-left'>
              ...
              <div className='flex items-center justify-start p-2 space-x-10 bg-gray-50 rounded-md'>
                <div>
                  <p className='text-sm font-bold'>Type</p>
